@sanity_final_live @wip
Feature:Sanity

    @live_checkout @reinstall
    ...
    Scenario: Sanity test for Grocery Android
	   ...
	   Then I go to my basket
	   Then I start checkout process from basket
	   Then I tap continue on checkout from checking
	   And i complete my checkout process
